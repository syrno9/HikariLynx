...
languages.showNewLanguage = function(data, id) {
  ...
  feLabel.innerText = data.frontEnd;
  ...
  packLabel.innerText = data.languagePack;
  ...
  button.type = 'submit';
  button.innerText = 'Delete language';
