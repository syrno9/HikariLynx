...
hashBans.showNewHashBan = function(typedHash, typedReason, id) {
  ...
  userLabel.innerText = api.getCookies().login;
  ...
  dateLabel.innerText = api.formatDateToDisplay(new Date());
  ...
  submit.type = 'submit';
  submit.innerText = 'Lift hash ban';
